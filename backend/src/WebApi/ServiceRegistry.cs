...
using Domain.Services.UserManagementService;
...
using Services.Implementation.Address;
...
internal static class ServiceRegistry
{
    public static WebApplication BuildApp(WebApplicationBuilder builder)
    {
        ...
        builder.Services.AddAuthentication(Services.Implementation.Authorization.ServiceCollectionExtensions.AuthenticationScheme)
            .AddCookie(Services.Implementation.Authorization.ServiceCollectionExtensions.AuthenticationScheme, options =>
            {
    ...
    private static void AddDomainServices(IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddSingleton<IAddressParser, RussianAddressParser>();
        ...
        services.AddIAuthorizationServiceImplementation();
    }

    private static void AddUseCases(IServiceCollection services)
    {
        services.AddScoped<GetBuildingBasementInformationByAddressUseCase>();
        ...
        services.AddScoped<UpdateExistingPlanUseCase>();
        services.AddScoped<SignInUseCase>();
        services.AddScoped<AddUserUseCase>();
        services.AddScoped<DeleteUserUseCase>();
        services.AddScoped<GetUserListUseCase>();
