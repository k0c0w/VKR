...
public readonly struct ErrorMessage : IEquatable<ErrorMessage>
{
    ...
    public static readonly ErrorMessage EntityAlreadyExists = DomainError("Сущность уже существует.");
    
    public static readonly ErrorMessage AbstractError = SystemError("Непредвиденная ошибка.");

    public static readonly ErrorMessage DataInconsistency = DomainError("Данные устарели.");
