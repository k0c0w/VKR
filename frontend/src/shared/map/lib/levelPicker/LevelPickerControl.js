...
L.Control.LevelPicker = L.Control.extend({
    ...
    initialize: function (options) {
        ...
        this.levelLabels = options.levelLabels || ["1"];
        this.selectedLevelIndex = options.selectedLevelIndex || 0;
        this.disableRubbishBin = options.disableRubbishBin;
        this.showLevelButtons = options.showLevelButtons;
        this.controlDisabled = options.controlDisabled;
    },
