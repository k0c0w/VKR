...
export function toGeoJsonWithId(layer: LayerWithFeatureId): FeatureWithId<number | guid, LineString | GeoJsonPolygon | Point> {
    ...
    return feature as FeatureWithId<number | guid, LineString | GeoJsonPolygon | Point>;
}
