import { Card, Typography, Box, FormControl, TextField, FormLabel, Button, useTheme, Alert } from "@mui/material";
    ...
    return (
      ...
      >
        ...
        >
          ...
          <Alert severity="error" sx={{ width: '100%', display: !initialErrors?.globalErrorMessage ? 'none': undefined }}>
